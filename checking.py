...
import matplotlib.pyplot as plt# importing the necessary packages
import numpy as np
import pandas as pd
import seaborn as sns
# Load the dataset from the .csv file using pandas
data = pd.read_csv ("creditcard.csv")
print(data.columns)#exploring the data set
print(data.shape)
print(data.describe ())#checking what al elements are there
...
sns.heatmap(corrmat1, vmax= 1.0, square=False)
plt.show()
